...
#include <opencv2/core/parallel/parallel_backend.hpp> // For setParallelForBackend

#include "StdThreadParallelForAPI.hpp" // Include your custom backend header
...
{
    // Create and set your custom backend
    auto std_thread_backend = std::make_shared<StdThreadParallelForAPI>();
    cv::parallel::setParallelForBackend(std_thread_backend);
